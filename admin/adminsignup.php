            ...
            <div class="col-md-12 col-md-offset-6">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="signup_add.php">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Enter Your Name..."  name="fullname" type="text" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Enter Your Address..."  name="address" type="text" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Enter Your Phone..."  name="phone" type="number" required>
                                </div>
